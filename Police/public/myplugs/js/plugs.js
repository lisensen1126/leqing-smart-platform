...
$
		.extend( {
			...
			jq_Panel : function(e) {
				...
				var str = "<div class='jq_dvpanel'  style='z-index:2;box-shadow: 0px 0px 5px #BCD4E5;border: 1px solid #BCD4E5 !important;position:absolute;margin-top:-100px;background-Color:#fff;width:"
