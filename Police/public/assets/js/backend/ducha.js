            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        //         return '<a href="' + "baoming/index?ducha_id=" + row['id'] + '" class="btn btn-xs btn-info btn-dialog" title="报名列表[' + row['id'] + ']" data-area=\'["95%","95%"]\'><i class="fa fa-bar-chart"></i></a>';
                        //     }
                        // },
                        // {
                        //     field: 'statistics', title: "权限", operate: false, formatter: function (value, row, index) {
                        //         return '<a href="' + "ducha/edit2?ids=" + row['id'] + '" class="btn btn-xs btn-info btn-dialog" title="权限[' + row['id'] + ']" data-area=\'["95%","95%"]\'><i class="fa fa-bar-chart"></i></a>';
                        //     }
                        // },
