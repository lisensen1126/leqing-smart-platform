define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            columns.push({
                field: 'operate', title: __('Operate'), width: 230, table: table, events: Table.api.events.operate, formatter: Table.api.formatter.operate, clickToSelect: false, buttons: [
                    {
                        name: "recorddata",
                        title: function (row) {
