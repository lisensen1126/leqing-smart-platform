define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'weifa2/index' + location.search,
                    add_url: 'weifa2/add',
                    edit_url: 'weifa2/edit',
                    del_url: 'weifa2/del',
                    multi_url: 'weifa2/multi',
                    import_url: 'weifa2/import',
                    table: 'weifa',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'paichusuo.id', title: __('Paichusuo.id')},
                        {field: 'paichusuo.name', title: __('Paichusuo.name'), operate: 'LIKE'},
                        {field: 'paichusuo.createtime', title: __('Paichusuo.createtime'), operate:'RANGE', addclass:'datetimerange', autocomplete:false, formatter: Table.api.formatter.datetime},
