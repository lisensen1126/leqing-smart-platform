...
class Ajax extends Backend
{
    ...
    public function group()
    {
        ...
        $grouplist = Db::name('user_group')->field('id as value,name')->order('id desc')->select();
    ...
    public function organ()
    {
        ...
        $organlist = Db::name('organ')->where($where)->field('id as value,name')->order('id desc')->select();

        $this->success('', '', $organlist);
    }
    ...
    public function depart()
    {
        ...
        $departlist = Db::name('depart')->where($where)->field('id as value,name')->order('id desc')->select();

        $this->success('', '', $departlist);
    }
    ...
    {
        $userlist = null;
        $depart_id = $this->request->get('depart_id', '');
        if ($depart_id || $depart_id === '0') {
            $where['depart_id'] = $depart_id;
        }
        $userlist = Db::name('user')->where($where)->field('id as value,nickname as name')->order('id desc')->select();
