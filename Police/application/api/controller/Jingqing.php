...

{
    ...
    protected $noNeedLogin = ['index','index1', 'test1','File','Add','Online','Complete','Find'];
    ...
    public function Add(){
        ...
        $jingqing->title = $_GET["title"];

        $jingqing->content = $_GET["content"];

        $jingqing->address = $_GET["address"];

        $jingqing->type1 = $_GET["type1"];

        $jingqing->type2 = $_GET["type2"];

        $jingqing->type3 = $_GET["type3"];

        $jingqing->image = $_GET["image"];

        $jingqing->videoimage = $_GET["video"];

        $jingqing->lng = $_GET["lng"];

        $jingqing->lat = $_GET["lat"];

        $jingqing->paichusuo = $_GET["paichusuo"];
        $jingqing->admin_id = $_GET["admin_id"];
    ...
    public function Index(){
        ...
        if(isset($_GET['state']))$data['state'] = array('like','%'.$_GET['state'].'%');     

        // $data['stoptime'] = array('egt', time());

        $res=$Jingqing
->with(['admin','paichusuo'])
        ->where($data)->limit(100)->order("id desc")->select();
    ...
    public function Index1(){
        ...
        $res=$Jingqing->with(['admin','paichusuo'])->where($data)->limit(100)->order("id desc")->select();
